...
function mage_bus_selected_seat_item(){
    ...
    // TODO: Add your custom code to book the whole bus here, instead of seat selection logic
    ...
    ?>
    <div class="flexEqual mage_bus_selected_seat_item">
        <h6><?php echo __('Bus Booking', 'bus-ticket-booking-with-seat-reservation'); ?></h6>
        <?php
